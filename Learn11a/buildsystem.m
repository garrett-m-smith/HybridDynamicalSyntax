...
%sys.timecrit = 0.8;
%sys.timecrit = 0.5;
sys.weight0 = 0.1;  % Weight parameter; must be non-zero, otherwise learning can't take place;
% With weight0 = 0, time always runs out before the system gets close
% enough to the criterion activation, so no event is triggered, and the
% program stops.
...
sys.zz0(1:sys.nstatevars) = [0; 1; sys.act0; sys.weight0; 0];  % Error, Input, Activation, Weight, Time
